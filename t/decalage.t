...
run {
    ...
    $r->parse($block->input);
    my $rd = $v->decalage($r);
    is($rd->formatted_normalize, $block->expect);
};

__END__

=== LCV Reference formatted_normalized and decalaged
--- input chomp
No 17:3
--- expect chomp
No 16:38

=== LCV Reference with accent formatted_normalized and decalaged
--- input chomp
Éz 17:3
--- expect chomp
Ez 16:38

=== LCV Reference with canonical book name
--- input chomp
Nombres 17:3
--- expect chomp
Nombres 16:38

=== LCV Reference with interval, first part decalé
--- input chomp
Ps 1:3-4
--- expect chomp
Ps 1:2-4

=== LCV Reference with interval, first and second part decalé
--- input chomp
Ps 1:5-6
--- expect chomp
Ps 1:6-7

=== LCV Reference with interval, second part decalé
--- input chomp
Ps 1:1-6
--- expect chomp
Ps 1:1-7

=== LCV Reference with interval, second part decalé, now its only one verse
--- input chomp
Ps 1:6-7
--- expect chomp
Ps 1:7
